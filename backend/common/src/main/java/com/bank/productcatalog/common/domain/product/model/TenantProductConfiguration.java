...
/**
 * Tenant-specific configuration of a product from the master catalog
 * This represents the configuration phase before a product becomes active
 */
@Data
@Document(collection = "tenant_product_configurations")
...
public class TenantProductConfiguration {
    ...
    // Customized terms
    private ProductTerms customTerms;
